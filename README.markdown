## Usage
    ...
    {exp:timetravel by='day' weblog='default_site'}
...
If you are using Timetravel to navigate through years, you need to add year='{segment_n}' and dynamic='off' to your weblog:entries tag.

    {exp:weblog:entries weblog='default_site' dynamic='off' year='{segment_n}'}
        // Your entry data
    {/exp:weblog:entries}